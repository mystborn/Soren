...
SOREN_EXPORT void circle_collider_debug_draw(CircleCollider* collider, SDL_Renderer* renderer, SDL_FColor color);
...
SOREN_EXPORT void polygon_collider_debug_draw(PolygonCollider* collider, SDL_Renderer* renderer, SDL_FColor color);
...
SOREN_EXPORT void box_collider_debug_draw(BoxCollider* collider, SDL_Renderer* renderer, SDL_FColor color);
...
SOREN_EXPORT void line_collider_debug_draw(LineCollider* collider, SDL_Renderer* renderer, SDL_FColor color);
...
SOREN_EXPORT void point_collider_debug_draw(PointCollider* collider, SDL_Renderer* renderer, SDL_FColor color);
...
#define soren_circle_collider_overlaps_impl_selector(arg1, ...) \
    _Generic((arg1), \
...
#define circle_collider_overlaps(collider, arg1, ...) \
    soren_circle_collider_overlaps_impl_selector((arg1) __VA_OPT__(,) __VA_ARGS__)((collider), (arg1) __VA_OPT__(,) __VA_ARGS__)

#define soren_circle_collider_collides_impl_selector(arg1, arg2) \
    _Generic((arg1), \
        Collider*: circle_collider_collides_collider, \
...
#define circle_collider_collides(collider, arg1, arg2, ...) \
    soren_circle_collider_collides_impl_selector(arg1, arg2)((collider), (arg1), (arg2) __VA_OPT__(,) __VA_ARGS__)
...
#define soren_box_collider_overlaps_impl_selector(arg1, ...) \
    _Generic((arg1), \
...
#define box_collider_overlaps(collider, arg1, ...) \
    soren_box_collider_overlaps_impl_selector((arg1) __VA_OPT__(,) __VA_ARGS__)((collider), (arg1) __VA_OPT__(,) __VA_ARGS__)

#define soren_box_collider_collides_impl_selector(arg1, arg2) \
    _Generic((arg1), \
        Collider*: box_collider_collides_collider, \
...
#define box_collider_collides(collider, arg1, arg2, ...) \
    soren_box_collider_collides_impl_selector(arg1, arg2)((collider), (arg1), (arg2) __VA_OPT__(,) __VA_ARGS__)
...
#define soren_polygon_collider_overlaps_impl_selector(arg1, ...) \
    _Generic((arg1), \
...
#define polygon_collider_overlaps(collider, arg1, ...) \
    soren_polygon_collider_overlaps_impl_selector((arg1) __VA_OPT__(,) __VA_ARGS__)((collider), (arg1) __VA_OPT__(,) __VA_ARGS__)

#define soren_polygon_collider_collides_impl_selector(arg1, arg2) \
    _Generic((arg1), \
        Collider*: polygon_collider_collides_collider, \
...
#define polygon_collider_collides(collider, arg1, arg2, ...) \
    soren_polygon_collider_collides_impl_selector(arg1, arg2)((collider), (arg1), (arg2) __VA_OPT__(,) __VA_ARGS__)
...
#define soren_line_collider_overlaps_impl_selector(arg1, ...) \
    _Generic((arg1), \
...
#define line_collider_overlaps(collider, arg1, ...) \
    soren_line_collider_overlaps_impl_selector((arg1) __VA_OPT__(,) __VA_ARGS__)((collider), (arg1) __VA_OPT__(,) __VA_ARGS__)

#define soren_line_collider_collides_impl_selector(arg1, arg2) \
    _Generic((arg1), \
...
#define line_collider_collides(collider, arg1, arg2, ...) \
    soren_line_collider_collides_impl_selector(arg1, arg2)((collider), (arg1), (arg2) __VA_OPT__(,) __VA_ARGS__)
...
#define soren_point_collider_overlaps_impl_selector(arg1, ...) \
    _Generic((arg1), \
...
#define point_collider_overlaps(collider, arg1, ...) \
    soren_point_collider_overlaps_impl_selector((arg1) __VA_OPT__(,) __VA_ARGS__)((collider), (arg1) __VA_OPT__(,) __VA_ARGS__)

#define soren_point_collider_collides_impl_selector(arg1, arg2) \
    _Generic((arg1), \
        Collider*: cicle_collider_collides_collider, \
...
#define point_collider_collides(collider, arg1, arg2, ...) \
    soren_point_collider_colliders_impl_selector(arg1, arg2)((collider), (arg1), (arg2) __VA_OPT__(,) __VA_ARGS__)
...
#define soren_collider_overlaps_impl_selector(arg1, ...) \
    _Generic((arg1), \
...
#define collider_overlaps_impl(collider, arg1, ...) \
    soren_collider_overlaps_impl_selector(arg1, __VA_OPT__(,) __VA_ARGS__)((collider), (arg1) __VA_OPT__(,) __VA_ARGS__)
...
#define collider_collides_impl(collider, arg1, arg2, ...) \
    soren_collider_collides_impl_selector(arg1, arg2)((collider), (arg1), (arg2) __VA_OPT__(,) __VA_ARGS__)

#define collider_overlaps(collider, arg1, ...) \
    _Generic((collider), \
        Collider*: soren_collider_overlaps_impl_selector(arg1 __VA_OPT__(,) __VA_ARGS__), \
        PointCollider*: soren_point_collider_overlaps_impl_selector(arg1 __VA_OPT__(,) __VA_ARGS__), \
        LineCollider*: soren_line_collider_overlaps_impl_selector(arg1 __VA_OPT__(,) __VA_ARGS__), \
        CircleCollider*: soren_circle_collider_overlaps_impl_selector(arg1 __VA_OPT__(,) __VA_ARGS__), \
        PolygonCollider*: soren_polygon_collider_overlaps_impl_selector(arg1 __VA_OPT__(,) __VA_ARGS__), \
        BoxCollider*: soren_box_collider_overlaps_impl_selector(arg1 __VA_OPT__(,) __VA_ARGS__) \
    )((collider), (arg1) __VA_OPT__(,) __VA_ARGS__)

#define collider_collides(collider, arg1, arg2, ...) \
    _Generic((collider), \
        Collider*: soren_collider_collides_impl_selector(arg1, arg2), \
        PointCollider*: soren_point_collider_collides_impl_selector(arg1, arg2), \
        LineCollider*: soren_line_collider_collides_impl_selector(arg1, arg2), \
        CircleCollider*: soren_circle_collider_collides_impl_selector(arg1, arg2), \
